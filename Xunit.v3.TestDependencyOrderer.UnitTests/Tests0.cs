...
/// <summary>
/// Represents a test class with dependencies on other test classes and methods.
/// </summary>
[DependsOnClass(typeof(Tests1))]
[DependsOnClass(typeof(Tests3))]
[TestCaseOrderer(typeof(TestDependencyTestCaseOrderer))]
public class Tests0 : TestBase, IClassFixture<CurrentTestContext>
{
    private readonly CurrentTestContext _currentTestContext;

    /// <summary>
    /// Initializes a new instance of the <see cref="Tests0"/> class.
    /// </summary>
    ...
    public Tests0(ITestContextAccessor testContextAccessor, GlobalTestContext globalTestContext, CurrentTestContext currentTestContext) : base(testContextAccessor, globalTestContext)
    {
    ...
    /// <summary>
    /// A test method that depends on <see cref="Test1"/>.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// A test method that depends on <see cref="TestB"/>.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// A test method that depends on <see cref="Test1"/> and <see cref="Test2"/>.
    /// </summary>
    [Fact]
    [DependsOnMethod(nameof(Test1))]
